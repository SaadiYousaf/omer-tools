  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        cardData: {
          // Send empty object instead of null to bypass validation
          Number: "",
          Expiry: "",
          Cvc: "",
          Name: "",
  ...
  return (
    <div className="checkout-page">
      ...
      <div className="checkout-header">
        <h2>
          Checkout{" "}
          {isGuestCheckout && <span className="guest-badge">Guest</span>}
        </h2>{" "}
        {/* ✅ SHOW GUEST BADGE */}
      ...
      <div className="checkout-form">
        ...
        {isGuestCheckout && (
          <div className="guest-notice">
            <p>
              You're checking out as a guest. You can still place your order
              ...
              <div className="info-preview">
                ...
                {userAddresses && userAddresses.length > 0 ? (
                  ...
                  <div className="no-address-notice">
                    <em>
                      No saved addresses found. Please enter your shipping
                      address below.
                    </em>
                  </div>
                )}
        ...
        <div className="confirm-collect-option">
          ...
          <p className="option-description">
            Select this option to collect your order from our store. No shipping
            charges will apply.
          </p>
        </div>
    ...
    <div className="order-success">
      ...
      {isGuestCheckout && (
        <div className="guest-success-notice">
          ...
          <p>
            Want to track your order and save your information for next time?
          </p>
          <button
